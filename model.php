...
=======
<?php require 'config.php'; if (!isset($_SESSION['logged_in'])) { header("Location: index.php"); exit; } ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="links">
            ...
            <a href="stash.php">Stash</a> 
            <a href="tips.php">Tips</a>
            <a href="model.php" style="color:var(--hot-pink);">AI Scan</a>
        </div>
    </div>
...
>>>>>>> cf3fd044704a5b22899f6e920b3c96c4ab9d3fc0
</html>